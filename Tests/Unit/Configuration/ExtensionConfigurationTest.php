...
use Cpsit\T3hauler\Configuration\ExtensionConfiguration;
...
{
    #[Test]
    public function extensionKeyMatchesSettingsInterface(): void
    {
        self::assertEquals(
            SettingsInterface::KEY,
            ExtensionConfiguration::EXTENSION_KEY
        );
